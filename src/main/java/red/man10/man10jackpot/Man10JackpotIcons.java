...
public class Man10JackpotIcons {
    ...
    public void setUpIcon(){
        ...
        ItemStack[] ico = {new ItemStack(Material.DIAMOND_BLOCK,1,(short)0),
                ...
                new ItemStack(Material.WHITE_WOOL,1,(short)2),
                new ItemStack(Material.CLAY_BALL,1,(short) 5),
                ...
                new ItemStack(Material.BRICK,1,(short) 0),
                ...
                new ItemStack(Material.INK_SAC,1,(short) 14),
                new ItemStack(Material.INK_SAC,1,(short) 11),
                new ItemStack(Material.INK_SAC,1,(short) 1),
                ...
                new ItemStack(Material.INK_SAC,1,(short) 3),
                new ItemStack(Material.SHULKER_BOX,1,(short) 0),
                new ItemStack(Material.INK_SAC,1,(short) 0),
                new ItemStack(Material.FLINT,1,(short) 0),
                new ItemStack(Material.INK_SAC,1,(short) 9),
                new ItemStack(Material.GLOWSTONE_DUST,1,(short) 0),
                new ItemStack(Material.INK_SAC,1,(short) 4),
                new ItemStack(Material.INK_SAC,1,(short) 6),
                new ItemStack(Material.INK_SAC,1,(short) 2),
                new ItemStack(Material.INK_SAC,1,(short) 12),
                new ItemStack(Material.COAL,1,(short) 0),
                new ItemStack(Material.INK_SAC,1,(short) 7),
                new ItemStack(Material.INK_SAC,1,(short) 5),
                new ItemStack(Material.INK_SAC,1,(short) 15),
                new ItemStack(Material.INK_SAC,1,(short) 8),
                new ItemStack(Material.DIAMOND,1,(short) 0),
                new ItemStack(Material.GOLD_INGOT,1,(short) 0),
                new ItemStack(Material.INK_SAC,1,(short) 10),
                new ItemStack(Material.PUMPKIN_SEEDS,1,(short) 0),
                new ItemStack(Material.STRING,1,(short) 0),
                new ItemStack(Material.GLOW_INK_SAC,1,(short) 13)};
